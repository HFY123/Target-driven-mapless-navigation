...
def create_encode_state_fn(vae, measurements_to_include):
    ...
    measure_flags = ["steer" in measurements_to_include,
                     ...
                     "distance" in measurements_to_include,
                     "angle" in measurements_to_include
                     ]
    ...
    def encode_state(env):
        ...
        #Distance to goal and angle to goal --hfy
        if measure_flags[3]: measurements.append(env.distance_to_goal / env.distance)
        if measure_flags[4]: measurements.append(0.5*env.angle1)
